export const fitBud = {
  id: 1,
  title: "FitBud",
  description: "A mobile web application which generates gym workout plans for users based on their individual profile to help them achieve their fitness goal.",
  images: [
